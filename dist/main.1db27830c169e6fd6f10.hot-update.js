  ...
  for (const date in history) {
    if (Object.prototype.hasOwnProperty.call(history, date)) {
      ...
      if (date == dataToday) {
        ...
        // const [day, month] = date.split("/").map(Number); // преобразуем в числа
        ...
        // historyDataLabel = date.toLocaleDateString("ru-RU", options); // форматируем для русской локали
      }
