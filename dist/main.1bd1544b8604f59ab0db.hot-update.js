  ...
  for (const date in history) {
    ...
    if (Object.prototype.hasOwnProperty.call(history, date)) {
      ...
      if (date === dataToday) {
        ...
        const options = { day: "numeric", month: "long", year: "numeric" }; // Опции для форматирования
