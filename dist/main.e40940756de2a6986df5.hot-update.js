    ...
    if (Object.prototype.hasOwnProperty.call(history, date)) {
      ...
      const historyItems = elements
        .map((item) => {
          ...
          const isExpense = item[0] == "-";
          const className = isExpense ? "expense" : "income";
          const formattedItem = isExpense ? `+${item.slice(1)}` : item;
