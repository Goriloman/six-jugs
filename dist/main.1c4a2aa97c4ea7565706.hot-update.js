    ...
    if (Object.prototype.hasOwnProperty.call(history, date)) {
      ...
      const historyItems = elements
        .map((item) => {
          ...
          const className = Number(isExpense) ? "expense" : "income";
          const formattedItem = Number(isExpense) ? `+${item}` : item;
          console.log(item);
