...
function calculationJugs() {
  for (const jug in jugs) {
    if (Object.prototype.hasOwnProperty.call(jugs, jug)) {
      ...
      jugElement.money += (amount * (jugElement.percent / 100)).toFixed(2);
