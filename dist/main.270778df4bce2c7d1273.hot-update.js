...
function dataProcessing(formInfo, button) {
  ...
  if ("moneyOutput" in formInfo) {
    ...
    button.classList.remove("good", "error");
    console.log(jugs[formInfo.jugs] >= formInfo.moneyInput);
