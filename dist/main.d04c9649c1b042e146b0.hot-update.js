    ...
    if (Object.prototype.hasOwnProperty.call(history, date)) {
      ...
      const historyItems = elements
        .map((item) => {
          ...
          const res = item[0] === "+" ? "income" : "expense";
      ...
      // Добавляем сгенерированное HTML в фрагмент
      fragment.appendChild(
        new DOMParser().parseFromString(historyItemHTML, "text/html").body
          .firstChild
      );
    }
  }
