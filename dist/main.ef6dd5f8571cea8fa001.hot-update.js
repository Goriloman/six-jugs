      ...
      if (sum == 100) {
        ...
        settingSlidersWrapper.forEach((settingSliderWrapper) => {
          ...
          if (specificClass) {
            ...
            jugs[classWithoutPrefix].percent = Number(
