...
window.onload = function () {
  ...
  function documentActions(e) {
    ...
    if (targetElement.closest(`.button-reset`)) {
      let buttonReset = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(".button-reset");
      let settingSliders = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelectorAll(
    ...
    if (targetElement.closest(`.button-reset-money`)) {
      let buttonReset = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(".button-reset-money");
      for (const jug in jugs) {
        if (Object.prototype.hasOwnProperty.call(jugs, jug)) {
    ...
    if (targetElement.closest(".button-apply")) {
      const buttonApply = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(".button-apply");
      const settingSliders = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelectorAll(".item-setting__slider");
      const itemSetting = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelectorAll(".item-setting");
...
(0,cookie__WEBPACK_IMPORTED_MODULE_3__.setCookie)("name", "value");
...
function displayData() {
  ...
  let jugsItems = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(".jugs__items");
  jugsItems.innerHTML = "";
...
function rangeInit() {
  const settingList = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(".setting__list");
  settingList.innerHTML = ""; // Очищаем предыдущий контент

  const fragment = cookie__WEBPACK_IMPORTED_MODULE_3__.document.createDocumentFragment(); // Создаем временный фрагмент для улучшенной производительности
  ...
  for (const jug in jugs) {
    if (Object.prototype.hasOwnProperty.call(jugs, jug)) {
      ...
      const itemElement = cookie__WEBPACK_IMPORTED_MODULE_3__.document.createElement("li");
  ...
  for (const jug in jugs) {
    if (Object.prototype.hasOwnProperty.call(jugs, jug)) {
      ...
      const settingSliderWrapper = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(
        `.item-setting-${jug}`
      );
...
let formInput = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(".money-form-input");
formInput.addEventListener("submit", getInfoForm);

let formOutput = cookie__WEBPACK_IMPORTED_MODULE_3__.document.querySelector(".money-form-output");
